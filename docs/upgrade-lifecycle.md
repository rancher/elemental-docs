...
In this context the System Upgrade Controller handles the Elemental upgrade jobs. [Verifying](#verifying-successful-upgrades) the correct execution of the upgrade jobs is a fundamental part of verifying the Elemental upgrade process.  
