...
* A machine (bare metal or virtualized) with TPM 2.0
  ...
  * Hint 4: A minimum volume size of 25 GB is recommended. See the [Elemental Teal partition table](installation#deployed-elemental-partition-table) for more details  
