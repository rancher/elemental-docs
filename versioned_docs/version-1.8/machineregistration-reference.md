...
spec:
  machineName: name
  labelPrefix: elemental.cattle.io
...
The prefix used for labels and annotations generated by the Elemental operator.

| Default value         |
|-----------------------|
| `elemental.cattle.io` |

If set to `-`, no prefix will be generated for the labels and annotations.
