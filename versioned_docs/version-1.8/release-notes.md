...
|----------------------------------------------------------------------|---------|------------------------------------------------------------------------------|
| [Elemental Operator](https://github.com/rancher/elemental-operator/) | v1.8.2  | [Link](https://github.com/rancher/elemental-operator/releases/tag/v1.8.2)    |
| [Elemental Toolkit](https://github.com/rancher/elemental-toolkit/)   | v2.3.4  | [Link](https://github.com/rancher/elemental-toolkit/releases/tag/v2.3.4)     |
| [Elemental Linux](https://github.com/rancher/elemental)              | v2.3.1  | [Link](https://github.com/rancher/elemental/releases/tag/v2.3.1)             |
...
The cloud-config defined in `MachineRegistrations` is not applying `after-install-chroot` stage in version 1.8.0.
Currently fixed since v1.8.1.
